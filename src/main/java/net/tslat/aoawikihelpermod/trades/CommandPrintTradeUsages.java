...
public class CommandPrintTradeUsages extends CommandBase {
	@Override
	public String getName() {
		return "printtradeusages";
	}

	@Override
	public String getUsage(ICommandSender sender) {
		return "/printtradeusages [clipboard] - Prints out all known AoA trader trades using the held item. Optionally copy contents to clipboard.";
	}
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
		...
		if (!world.isRemote) {
			...
			TradesWriter.printTradeUsages(sender, targetStack, copyToClipboard);
		}
	}
}
