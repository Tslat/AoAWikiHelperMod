...
public class ApplyBonusFunctionHelper extends LootFunctionHelper<ApplyBonusCount> {
	...
	public String getDescription(ApplyBonusCount function) {
		return "will vary in quantity depending on the level of " + FormattingHelper.createLinkableText(ObjectHelper.getEnchantmentName(function.enchantment.value(), 0), false, true) + " used";
	}
}
