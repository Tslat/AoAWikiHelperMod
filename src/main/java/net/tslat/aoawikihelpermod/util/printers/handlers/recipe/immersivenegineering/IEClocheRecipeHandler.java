package net.tslat.aoawikihelpermod.util.printers.handlers.recipe.immersivenegineering;
...
public class IEClocheRecipeHandler extends RecipePrintHandler {
	...
	public IEClocheRecipeHandler(ResourceLocation recipeId, JsonObject rawRecipe, @Nullable IRecipe<?> recipe) {
	...
	public String[] toTableEntry(@Nullable Item targetItem) {
		...
		int time = JSONUtils.getAsInt(this.rawRecipe, "time", 480);
