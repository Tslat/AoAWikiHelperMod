...
public class CommandPrintItemUsageRecipes extends CommandBase {
	@Override
	public String getName() {
		return "printusagerecipes";
	}

	@Override
	public String getUsage(ICommandSender sender) {
		return "/printUsageRecipes [clipboard] - Prints out all known and supported recipes containing the held item. Optionally copy contents to clipboard.";
	}
	...
	public void execute(MinecraftServer server, ICommandSender sender, String[] args) {
		...
		if (!world.isRemote) {
			...
			RecipeWriter.printItemRecipeUsages(targetStack, sender, copyToClipboard);
		}
	}
}
